  ...
  return (
    <div className="flex flex-col gap-8 justify-center items-center mt-15 sm:flex-row sm:justify-between md:justify-around">
      <section className="order-2 sm:order-1 md:w-[450px]">
        <div>
          <h2 className="text-4xl sm:text-5xl text-primary text-center sm:text-left">Pear kiwi</h2>
          <h2 className="text-4xl sm:text-5xl text-center text-primary sm:text-left">& Mint</h2>
        </div>
        <div className="mt-4">
